 ...
 */
    class QRsplit {
        ...
        public function toUpper()
        {
            ...
            while ($p<$stringLen) {
                $mode = self::identifyMode(wfPhpfunc::substr($this->dataStr, $p), $this->modeHint);
                if($mode == QR_MODE_KANJI) {
                    $p += 2;
                } else {
 ...
 */
    ...
    class QRcode {
        ...
        public function encodeString8bit($string, $version, $level)
        {
            ...
            $ret = $input->append($input, QR_MODE_8, wfPhpfunc::strlen($string), str_split($string));
            if($ret < 0) {
                unset($input);
                return NULL;
            }
